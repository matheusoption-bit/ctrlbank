...
import {
  ...
  AlertTriangle, Trash2, Lightbulb,
} from "lucide-react";
          ...
          {available.length === 0 ? (
            ...
            <>
              ...
              <div className="space-y-1.5">
                ...
                <input name="amount" type="number" step="0.01" min="1" required placeholder="0,00" className="input-c6 w-full" />
              </div>
...
export default function OrcamentosPageClient({ budgets, insights, categories, currentMonth, currentYear }: {
  ...
  return (
    <motion.div className="space-y-6" variants={container} initial="hidden" animate="show">
      ...
      <motion.header variants={item} className="flex items-center justify-between pt-2">
        <div>
          <p className="section-label mb-1">{formatMonthYear(currentMonth, currentYear)}</p>
